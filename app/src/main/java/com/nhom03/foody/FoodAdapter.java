...
public class FoodAdapter extends RecyclerView.Adapter<FoodAdapter.FoodViewHolder> {
    ...
    public FoodAdapter(Context fContext) {
    ...
    public class FoodViewHolder extends RecyclerView.ViewHolder {
        ...
        public FoodViewHolder(@NonNull View itemView) {
            super(itemView);
            foodImage = itemView.findViewById(R.id.orderCart_imageIv);
            foodName = itemView.findViewById(R.id.orderCart_productTv);
            foodPrice = itemView.findViewById(R.id.orderCart_priceTv);
